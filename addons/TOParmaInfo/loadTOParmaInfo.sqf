...
_serverInfoString = format ["<t color='#A0FFFFFF'>A3 Bad Company - A3Wasteland %1</t>", worldName];
...
_generalInfoString = "Forum: <t color='#0091CD'><a href='http://a3badcompany.ddns.net/forum/'>A3 Bad Company</a></t>";
