...
_minTimeBetweenWeatherChangesMin = 15;
...
// Fog intensity never exceeds this value. Must be between 0 and 1 and greater than or equal to _minimumFog (0 = no fog, 1 = pea soup). (Suggested value: 0.2).
_maximumFog = 0;
...
// When raining, rain intensity never falls below this value. Must be between 0 and 1 and less than or equal to _maximumRain (0 = no rain, 1 = maximum rain intensity). (Suggested value: 0.1);
_minimumRain = 0.1;

// When raining, rain intensity never exceeds this value. Must be between 0 and 1 and greater than or equal to _minimumRain (0 = no rain, 1 = maximum rain intensity). (Suggested value: 1);
_maximumRain = 0.2;
...
// Wind vector strength never exceeds this value. Must be greater or equal to 0 and greater than or equal to _minimumWind. (Suggested value: 5).
_maximumWind = 2;
...
_rainIntervalRainProbability = 100; // overcast syncing fubar, do not enable rain
