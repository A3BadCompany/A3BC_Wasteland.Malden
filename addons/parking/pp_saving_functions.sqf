...
if (isServer) then {
  ...
  pp_retrieve_vehicle_request_handler = {
    ...
    if (!isARRAY(_vehicle_data)) exitWith {
      ...
      [_player, format["An error occurred, your vehicle (%2) could not be retrieved. Please report this error to Administrator.", _vehicle_id], "Retrieval Error"] call pp_notify;
    };
    ...
    if (isNil "_vehicle") exitWith {
      ...
      [_player, format["An error occurred, your vehicle (%1) could not be restored. Please report this error to Administrator.", _vehicle_id], "Restoring Error"] call pp_notify;
    };
