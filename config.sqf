...
if (isServer) then
{
	_territoryFile = selectRandom ["Airport", "Arudy", "Blanches", "Cancon", "Chapoi", "Dourdan", "Goisse", "Houdan", "LaPessagne", "Larche", "LaRiviere", "LaTrinite", "LePort", "MilitaryBase", "Moray", "SaintLouis"];
	config_territory_markers = compileFinal preprocessFileLineNumbers format ["mapConfig\territories\%1.sqf", _territoryFile];
