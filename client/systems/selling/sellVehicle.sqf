...
storeSellingHandle = _this spawn
{
	...
	#define CHOPSHOP_PRICE_RELATIONSHIP 2.5 // sell price = brand-new store price divided by CHOPSHOP_PRICE_RELATIONSHIP
	#define CHOPSHOP_PRICE_RELATIONSHIP_OP 1.8 // sell price = brand-new store price divided by CHOPSHOP_PRICE_RELATIONSHIP_OP
	#define VEHICLE_MAX_SELLING_DISTANCE 100
