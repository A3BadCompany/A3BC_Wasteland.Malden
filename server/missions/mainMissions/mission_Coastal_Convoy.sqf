...
private ["_vehChoices", "_convoyVeh", "_veh1", "_veh2", "_veh3", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_vehicleName2", "_numWaypoints", "_box1", "_box2", "_box3", "_randomBox1", "_randomBox2", "_randomBox3"];
...
_successExec =
{
	...
	_randomBox3 = selectRandom ["mission_USLaunchers","mission_USSpecial","mission_Main_A3snipers"];
