...
private ["_cashObjects", "_cash", "_cashPos", "_box1", "_randomBox1", "_boxPos", "_vehicleClass", "_vehicle"];
...
_setupObjects =
{
	...
	_missionHintText = format ["A treasure containing <t color='%1'>$300,000</t> and weapons is being recovered.<br/>If you want to capture it, you will need diving gear and an underwater weapon.", moneyMissionColor];
};
...
_successExec =
{
	...
	// Give the rewards
	{
		_x setVariable ["cmoney", 25000, true];
