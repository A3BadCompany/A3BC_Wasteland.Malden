...
#define STORE_CLEANUP_TIME (10*60) // Dropped store items cleanup time
#define STORE_CLEANUP_RADIUS 10.0 // Radius in meters to scan near store NPCs for dropped items
