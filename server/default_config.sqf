...
A3W_maxMoney = 50000000;           // Maximum amount of money that will save on players and crates
...
A3W_bleedingTime = 90;             // Time in seconds for which to allow revive after a critical injury (minimum 10 seconds) - to disable revive, go in addons\far_revive\FAR_defines.sqf
...
A3W_artilleryShells = 10;          // Number of shells per strike
...
A3W_artilleryAmmo = "R_230mm_fly"; // CfgAmmo class of fired shells, also available for example are the more powerful "R_230mm_fly" and less powerful "ModuleOrdnanceMortar_F_ammo"
...
//Bounty settings
A3W_bountyMax = 1000000;           // Maximum amount of money that can be set as a bounty on someone
A3W_bountyMinStart = 100000;       // Minimum amount of money to start a bounty on someone
A3W_bountyRewardPerc = 95;         // Percentage of cost that goes to bounty reward
...
A3W_vehicleLifetime = 1;           // Maximum lifetime in hours for saved vehicles across server restarts, regardless of usage (0 = no time limit)
...
A3W_territoryWarningIcons = 1;     // Show exclamation marks on map for territories where enemies are present (0 = no, 1 = yes)
A3W_payrollInterval = 10*60;       // Delay in seconds between each payroll
A3W_payrollAmount1 = 5000;         // Amount of money rewarded per territory on each payroll (1 at 9 players online)
A3W_payrollAmount2 = 7500;         // Amount of money rewarded per territory on each payroll (10 at 19 players online)
A3W_payrollAmount3 = 10000;        // Amount of money rewarded per territory on each payroll (20 at 29 players online)
A3W_payrollAmount4 = 12500;        // Amount of money rewarded per territory on each payroll (30 at 39 players online)
A3W_payrollAmount5 = 15000;        // Amount of money rewarded per territory on each payroll (40+ players online)
